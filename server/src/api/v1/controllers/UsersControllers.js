...
module.exports.Register = async (req, res) => {
    ...
    try {
        //--------- Req.body content
        const { name, email, password, clg_name, start_year, passing_year, clg_id, phone, linkedin_url, stream, course } = req.body;
        ...
        users = await UserModel.create({
            ...
            clg_id, clg_name, start_year, passing_year, socialMedia, phone, stream, course
        })
        await users.save();
